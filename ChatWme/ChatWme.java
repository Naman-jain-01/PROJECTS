...
public class ChatWme extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(1, 94, 83));
        ...
        jLabel1.setText("Message Recieved");
        jPanel1.add(jLabel1);
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(400, 0, 390, 80);
        ImageIcon icon = new ImageIcon("icon2.png");
        jLabel8.setBackground(new java.awt.Color(0, 0, 0));
        jLabel8.setFont(new java.awt.Font("Times New Roman", 2, 40));
        jLabel8.setIcon(icon);
        jLabel8.setForeground(new java.awt.Color(30, 31, 34));
        jLabel8.setText("ChatWMe");
...
void seticon()
{
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ChatWme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              ChatWme root = new ChatWme();  //initializing the main gui
